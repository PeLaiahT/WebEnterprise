...
namespace WebEnterprise.Areas.Identity.Pages.Account
{
    public class LoginModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    return await Route(Input.UserName);
                }
        ...
        public async Task<IActionResult> Route(string userName)
        {
            ...
            foreach(var role in roles){
                ...
                if (role == "Assurance")
                {
                    ...
                    return RedirectToAction("IndexManager", "Idea");
                }

                if (role == "Coordinator")
                {
                    
                    return RedirectToAction("IndexCoor", "Idea");
                }
                if (role == "Staff")
                {
            ...
            return Content("Not found role of user!");
